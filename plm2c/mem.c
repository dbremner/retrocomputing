 ...
 */
void
get_context_ptr(CONTEXT **context)
{
 ...
 */
void
free_var_list(DECL_ID *list_ptr)
{
	DECL_ID	*next_ptr;
 ...
 */
void
get_element_ptr(DECL_MEMBER **element)
{
	DECL_MEMBER	*el_ptr;
 ...
 */
void
free_decl_list(DECL_MEMBER *element)
{
	DECL_MEMBER	*el_ptr;
 ...
 */
void
get_param_ptr(PARAM_LIST **param)
{
 ...
 */
void
free_param_list(PARAM_LIST *param_list)
{
