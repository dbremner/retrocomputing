 ...
 */
void
element_copy(DECL_MEMBER *src, DECL_MEMBER *dest)
{
 ...
 */
int
get_var_list(DECL_ID **list_ptr, TOKEN *sep_token)
{
 ...
 */
void
parse_structure(DECL_MEMBER **list_ptr)
{
 ...
 */
int
parse_type(DECL_MEMBER *el_ptr, TOKEN *token)
{
	TOKEN	*temp_token;
	int	token_class;
 ...
 */
int
get_element(DECL_MEMBER **element, TOKEN *token)
{
	DECL_MEMBER	*el_ptr;
 ...
 */
void
parse_declare(TOKEN *first_token)
{
	DECL		decl;
